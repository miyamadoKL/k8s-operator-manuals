...
例:
  python3 .github/scripts/check-quotes.py spark-operator sources/spark-operator-2.5.1 kubeflow/spark-operator v2.5.1

終了コード: 不一致・リンク切れがあれば 1。
注意: 章冒頭の「本章で参照する公式リソース」のようなコードブロックを伴わないリンク一覧は照合対象外。
"""
import glob
import os
import re
